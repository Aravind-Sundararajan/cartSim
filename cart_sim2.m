...
y1 = 3; %x
y2 = 0; %xdot
y3 = 45*pi/180; %theta 1
y4 = 0; %thetadot
y5 = 45*pi/180; %theta 2
y6 = 0; %thetadot
...
q2(i,:) = dynamics_fxn2(y(i,:)+k1(i,:)*(deltaTime/2),mr,mc,L,k); 
k2(i,:) = [y(i,2),q2(i,1),y(i,4),q2(i,2), y(i,6), q2(i,3)];

q3(i,:) = dynamics_fxn2(y(i,:)+k2(i,:)*(deltaTime/2),mr,mc,L,k); 
k3(i,:) = [y(i,2),q3(i,1),y(i,4),q3(i,2), y(i,6), q3(i,3)];

q4(i,:) = dynamics_fxn2(y(i,:)+k3(i,:)*(deltaTime),mr,mc,L,k); 
...
pend1End = pend1Start +L*[sin(y(i,3)),-cos(y(i,3))]
pend2Start = pend1End;
pend2End = pend2Start +L*[sin(y(i,5)),-cos(y(i,5))]
